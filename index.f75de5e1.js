...
headers.forEach((header, columnIndex)=>{
    header.addEventListener("click", ()=>{
        ...
        } else sortOrder[columnIndex] = !sortOrder[columnIndex];
        const sortedRows = [
            ...rows
        ].sort((rowA, rowB)=>{
        ...
        if (!sortOrder[columnIndex]) sortedRows.reverse();
...
cells.forEach((cell)=>{
    cell.addEventListener("dblclick", (ev)=>{
        ...
        if (cell === editCell) {
            ...
            editInput.focus();
            const save = ()=>{
                const newValue = editInput.value.trim() === "" ? originText : editInput.value;
